...
import { EnvelopeClosedIcon, PersonIcon, GitHubLogoIcon, DrawingPinIcon, CornerBottomLeftIcon, CheckIcon,NotionLogoIcon, FigmaLogoIcon } from '@radix-ui/react-icons'
export default function Project_2() {
  return(
    ...
    <br/>
    <Flex style={{ margin: "0 10% 0 22%"}}>
    <Text size="2" style={{display:"flex"}}><FigmaLogoIcon/>&nbsp;
        <a href="https://www.figma.com/file/isSnrYXjMnbtKXAgmnAq7g/project1?type=design&node-id=0%3A1&mode=design&t=0kCsUbuYTGrPDTc5-1">AICC 기업 전화 화면구상</a>
      </Text>
    </Flex>
    </section>
  )
